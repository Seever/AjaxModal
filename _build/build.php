...
class AjaxModalPackage
{
    ...
    {
        $shema = $this->config['core'] . 'model/schema/' . $this->config['name_lower'] . '.mysql.schema.xml';
		if (empty($shema)) {
            return;
        }
...
$install = new AjaxModalPackage(MODX_CORE_PATH, $config);
